...
#    Jawab: Karena pada weighted graph (graph berbobot), setiap edge memiliki nilai atau "biaya" tersendiri. Jalur terpendek ditentukan dari akumulasi total bobot paling kecil, bukan dari banyaknya langkah (edge) yang dilalui.